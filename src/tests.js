...
describe("Odometer radix agnostic function", function() {
  const hexadecimalCases = [
    ...
    {input: [4, 3, 4, 9], output: [4, 3, 3, "A"], radix: 16},
    {input: [4, 3, 0, "A"], output: [4, 2, 9, "B"], radix: 16},
    {input: [3, 9, 0, "F"], output: [3, 9, 1, 0], radix: 16},
    {input: [3, 9, 9, "F"], output: [3, 9, "A", 0], radix: 16},
    {input: [3, 9, "A", "F"], output: [3, 9, "B", 0], radix: 16},
    {input: [3, 0, "F", "F"], output: [0, 1, 0, 0], radix: 16},
    {input: [3, 9, "F", "F"], output: [0, "A", 0, 0], radix: 16},
    {input: [3, "A", "F", "F"], output: [0, "B", 0, 0], radix: 16},
